...
namespace ProyectoVenta.Controllers
{
    ...
    public class InventarioController : Controller
    {
        ...
        {
            List<Producto> oLista = _daProducto.Listar();
        ...
        {
            bool respuesta = _daProducto.Eliminar(idproducto);
            return Json(new { respuesta = respuesta });
        }
        ...
        {
            List<Categoria> oLista = _daCategoria.Listar();
            return Json(new { data = oLista });
        }
        ...
        {
            bool respuesta = _daCategoria.Eliminar(idcategoria);
            return Json(new { respuesta = respuesta });
        }
    }
}
